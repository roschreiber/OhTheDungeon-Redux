...
public class NoiseGenerator {
	...
	public double noise(int x, int y, int z, int octaves, double zoom) {
		...
		noise = this.generator.noise((double) x / zoom, (double) y / zoom, (double) z / zoom, (int) octaves, 1f, 1,
				true);
	...
	public double noise(int x, int z, int octaves, double zoom) {
		...
		switch (octaves) { // Define values to adjust the perlins noise generator output to be more
							// controllable.
