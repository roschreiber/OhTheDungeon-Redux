...
public class I18n {
	...
	public SpecialItem GUUDE = new SpecialItem("Boulderfistian Golden Record",
	...
	public SpecialItem Eldritch_Blade_of_the_Inferno = new SpecialItem("Eldritch Blade of the Inferno",
...
//    );
	...
	public String Menu_remove_click_fail = "Cannot remove dungeon world, please manually delete otd_dungeon_shadow_world";
	...
	public String Automatic_Diagnostic_Lore = "Check if OTD works properly on your server";
	public String Preview = "Preview";
	public String Preview_Lore1 = "See the appearance of the dungeon";
	public String Preview_Lore2 = "A link will be sent to your chatbox";

	public String Aether_Description = "Aether Dungeons are located within structures resembling a parthenon in the sky. These have multiple floors, typically three, each with multiple rooms.";
	public String Roguelike_Description = "Roguelike dungeon generates large underground roguelike dungeon structures. Layout, loot and size of the dungeons are random.";
	public String Doomlike_Description = "Doomlike dungeons meant to resemble levels from retro \"2 1/2d\" first-person shooters, and was inspired by earlier dungeons mods and by Oblige (especially version 3.57), a random level generator for Doom.";
	public String BattleTower_Description = "Battle tower adds a simple tower type dungeon for explore";
	public String DraylarBattleTower_Description = "Just another type of battle tower";
	public String Smoofy_Description = "DungeonMaze generates dungeons with a lot of cool and strange stuff in it. A small garden is always at the middle of dungeon.";
	public String Lich_Description = "The Lich Tower is a landmark from the Twilight Forest mod. At the very top of this tower the Twilight Lich lives, rules, and performs sorcery. The Lich Tower has a large main room, and a bunch of smaller rooms stemming off of it.";
	public String Antman_Description = "Antman dungeon has narrow, wild tunnels that seemingly go nowhere, but a huge stronghold will hide in it.";
	public String Castle_Description = "Castle Dungeons are procedurally generated castles that all have a different appearance. This makes for an amazing variety of structures.";

	public String Castle_King_Name = "Lord of Cinder";
	...
	public String Use_Vanilla_Lore = "Use built-in bosses";
	public String Use_MythicMobs = "Use MythicMobs";
	public String Require_MythicMobs = "Require MythicMobs installed";
	public String Use_MythicMobs_Lore = "Use MythicMobs to create Boss";
	...
	public String WorldGeneratorCompatibility_Lore2 = "* This is not needed for most of world generator, but you may need this for some world generators with usual bottom/sealevel";
	...
	public String Use_EcoBosses = "Use EcoBosses";
	public String Require_EcoBosses = "Require EcoBosses installed";
	public String Use_EcoBosses_Lore = "Use EcoBosses to create Boss";
	public String Use_EcoBosses_Lores[] = { "* Mob with name 'otd_lich_boss' will be used for boss of Lich Tower.",
			"* Mob with name 'otd_castle_king' will be used for boss of Castle.",
			"* Mob with prefix 'otd_small_boss_' will be used for small boss." };
	...
	public static void init() {
		...
		if (file.exists()) {
			try (BufferedReader reader = new BufferedReader(
					new InputStreamReader(new FileInputStream(file_path), "UTF8"))) {
	...
	public static void check_update() {
		...
		if (I18n.instance.lang_version == 19) {
			update19();
		}
		if (I18n.instance.lang_version == 20) {
			update20();
		}
		if (I18n.instance.lang_version == 21) {
			update21();
		}
	...
	public static void update22() {
		I18n.instance.WorldGeneratorCompatibility = "World Generator Compatibility";
		I18n.instance.WorldGeneratorCompatibility_Lore1 = "* Config for world generator compatibility";
		I18n.instance.WorldGeneratorCompatibility_Lore2 = "* This is not needed for most of world generator, but you may need this for some world generators with usual bottom/sealevel";
	...
	public static void update21() {
		...
		I18n.instance.Roguelike_Description = "Roguelike dungeon generates large underground roguelike dungeon structures. Layout, loot and size of the dungeons are random.";
		I18n.instance.Doomlike_Description = "Doomlike dungeons meant to resemble levels from retro \"2 1/2d\" first-person shooters, and was inspired by earlier dungeons mods and by Oblige (especially version 3.57), a random level generator for Doom.";
		I18n.instance.BattleTower_Description = "Battle tower adds a simple tower type dungeon for explore";
		I18n.instance.DraylarBattleTower_Description = "Just another type of battle tower";
		I18n.instance.Smoofy_Description = "DungeonMaze generates dungeons with a lot of cool and strange stuff in it. A small garden is always at the middle of dungeon.";
		I18n.instance.Lich_Description = "The Lich Tower is a landmark from the Twilight Forest mod. At the very top of this tower the Twilight Lich lives, rules, and performs sorcery. The Lich Tower has a large main room, and a bunch of smaller rooms stemming off of it.";
		I18n.instance.Antman_Description = "Antman dungeon has narrow, wild tunnels that seemingly go nowhere, but a huge stronghold will hide in it.";
		I18n.instance.Castle_Description = "Castle Dungeons are procedurally generated castles that all have a different appearance. This makes for an amazing variety of structures.";

		I18n.instance.Castle_King_Name = "Lord of Cinder";
		...
		I18n.instance.Use_Vanilla_Lore = "Use built-in bosses";
		I18n.instance.Use_MythicMobs = "Use MythicMobs";
		...
		I18n.instance.lang_version = 22;
	}

	public static void update20() {
		I18n.instance.Menu_remove_click_fail = "Cannot remove dungeon world, please manually delete otd_dungeon_shadow_world";

		I18n.instance.lang_version = 21;
	}

	public static void update19() {
		I18n.instance.Automatic_Diagnostic_Lore = "Check if OTD works properly on your server";
		I18n.instance.Preview = "Preview";
		I18n.instance.Preview_Lore1 = "See the appearance of the dungeon";
		I18n.instance.Preview_Lore2 = "A link will be sent to your chatbox";

		I18n.instance.lang_version = 20;
	}
	...
	public static void update2() {
		...
		I18n.instance.GUUDE = new SpecialItem("Boulderfistian Golden Record",
				"\"You're Watching Guude Boulderfist...\"");
