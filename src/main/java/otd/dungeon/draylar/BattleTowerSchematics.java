...
public class BattleTowerSchematics {
	...
	public static void init(JavaPlugin plugin) {
		...
		frosted_default_spike_1 = new BattleTowerSchematic(plugin,
				"draylars-battle-towers/frosted/default_spike_1.json", 8, 21);
		...
		mushroom_top = new BattleTowerSchematic(plugin, "draylars-battle-towers/mushroom/top.json", true, false, 32,
				32);

		sandy_default = new BattleTowerSchematic(plugin, "draylars-battle-towers/sandy/default.json", 8, 8);
		sandy_entrance = new BattleTowerSchematic(plugin, "draylars-battle-towers/sandy/entrance.json", false, true, 11,
				11);
		sandy_top = new BattleTowerSchematic(plugin, "draylars-battle-towers/sandy/top.json", 8, 8);
		sandy_sandcastle_top = new BattleTowerSchematic(plugin, "draylars-battle-towers/sandy/sandcastle_top.json",
				true, false, 10, 10);
...
//        stone_bottom = new BattleTowerSchematic(plugin, "draylars-battle-towers/stone/bottom.json");
		...
		stone_entrance = new BattleTowerSchematic(plugin, "draylars-battle-towers/stone/entrance.json", false, true, 8,
				8);
		...
		}
		{
			...
			JUNGLE.layers = new BattleTowerSchematic[] { jungle_branch, jungle_default, jungle_lookout,
					jungle_stairs_wrap, };
		}
		{
			MUSHROOM = new Theme();
		...
		}
		{
			...
			STONE.layers = new BattleTowerSchematic[] { stone_blacksmith, stone_default, stone_lake, stone_library,
					stone_lookout, stone_mineshaft, stone_original, stone_plains, };
		}
	...
	public static boolean place(World world, Random rand, int x, int z) {
		...
		if (WorldConfig.wc.dict.containsKey(world.getName())) {
			...
			top = swc.worldParameter.sealevel;
			low = swc.worldParameter.bottom;
		}

		if (y < low + 32 || y > top + 128)
			return false;
