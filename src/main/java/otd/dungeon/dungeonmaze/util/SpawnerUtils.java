...
public class SpawnerUtils {
	 ...
	 * 
	 * @param b Block to get the creature spawner state instance from (Block must be
	 *          a spawner)
	...
	/**
	 * Check whether a block can be casted to a creature spawner state instance or
	 * not
	 * 
	 * @param b The block to check
	 * @return True if the block could be casted to a creature spawner state
	 *         instance
	 */
	...
	/**
	 * Create a creature spawner block at the given block. The spawner will then be
	 * configured to spawn the given entity type.
	 *
