...
public class MossPopulator extends MazeRoomBlockPopulator {
	...
	public void populateRoom(MazeRoomBlockPopulatorArgs args) {
		...
		final Material block = world.getChunkType(bx, by, bz);

		if (block == Material.COBBLESTONE)
			world.setChunkType(bx, by, bz, Material.MOSSY_COBBLESTONE);

		if (block == Material.STONE_BRICKS)
			world.setChunkType(bx, by, bz, Material.MOSSY_STONE_BRICKS);
	}
