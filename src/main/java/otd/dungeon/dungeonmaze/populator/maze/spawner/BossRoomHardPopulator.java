...
public class BossRoomHardPopulator extends MazeLayerBlockPopulator {
	...
	public void populateLayer(MazeLayerBlockPopulatorArgs args) {
		...
		for (int x2 = x; x2 < x + 15; x2 += 1)
			for (int z2 = z; z2 < z + 15; z2 += 1)
				world.setChunkType(x2, y, z2, Material.OBSIDIAN);
		...
		world.setChunkType(x + 5, y + 1, z + 7, Material.GLASS);
		world.setChunkType(x + 5, y + 1, z + 8, Material.GLASS);
		world.setChunkType(x + 6, y + 1, z + 6, Material.GLASS);
		world.setChunkType(x + 6, y + 1, z + 9, Material.GLASS);
		world.setChunkType(x + 7, y + 1, z + 5, Material.GLASS);
		world.setChunkType(x + 7, y + 1, z + 10, Material.GLASS);
		world.setChunkType(x + 8, y + 1, z + 5, Material.GLASS);
		world.setChunkType(x + 8, y + 1, z + 10, Material.GLASS);
		world.setChunkType(x + 9, y + 1, z + 6, Material.GLASS);
		world.setChunkType(x + 9, y + 1, z + 9, Material.GLASS);
		world.setChunkType(x + 10, y + 1, z + 7, Material.GLASS);
		world.setChunkType(x + 10, y + 1, z + 8, Material.GLASS);
		...
		world.setChunkType(x + 5, y + 2, z + 7, Material.GLASS);
		world.setChunkType(x + 5, y + 2, z + 8, Material.GLASS);
		world.setChunkType(x + 6, y + 2, z + 6, Material.GLASS);
		world.setChunkType(x + 6, y + 2, z + 9, Material.GLASS);
		world.setChunkType(x + 7, y + 2, z + 5, Material.GLASS);
		world.setChunkType(x + 7, y + 2, z + 10, Material.GLASS);
		world.setChunkType(x + 8, y + 2, z + 5, Material.GLASS);
		world.setChunkType(x + 8, y + 2, z + 10, Material.GLASS);
		world.setChunkType(x + 9, y + 2, z + 6, Material.GLASS);
		world.setChunkType(x + 9, y + 2, z + 9, Material.GLASS);
		world.setChunkType(x + 10, y + 2, z + 7, Material.GLASS);
		world.setChunkType(x + 10, y + 2, z + 8, Material.GLASS);
		world.setChunkType(x + 12, y + 2, z + 3, Material.GLASS);
		world.setChunkType(x + 12, y + 2, z + 12, Material.GLASS);
		world.setChunkType(x + 6, y + 3, z + 7, Material.GLASS);
		world.setChunkType(x + 6, y + 3, z + 8, Material.GLASS);
		world.setChunkType(x + 7, y + 3, z + 6, Material.GLASS);
		world.setChunkType(x + 7, y + 3, z + 9, Material.GLASS);
		world.setChunkType(x + 8, y + 3, z + 6, Material.GLASS);
		world.setChunkType(x + 8, y + 3, z + 9, Material.GLASS);
		world.setChunkType(x + 9, y + 3, z + 7, Material.GLASS);
		world.setChunkType(x + 9, y + 3, z + 8, Material.GLASS);
		world.setChunkType(x + 7, y + 4, z + 7, Material.GLASS);
		world.setChunkType(x + 7, y + 4, z + 8, Material.GLASS);
		world.setChunkType(x + 8, y + 4, z + 7, Material.GLASS);
		world.setChunkType(x + 8, y + 4, z + 8, Material.GLASS);

		// Netherbrick hull
		world.setChunkType(x + 6, y + 1, z + 7, Material.NETHER_BRICKS);
		world.setChunkType(x + 6, y + 1, z + 8, Material.NETHER_BRICKS);
		world.setChunkType(x + 7, y + 1, z + 6, Material.NETHER_BRICKS);
		world.setChunkType(x + 7, y + 1, z + 9, Material.NETHER_BRICKS);
		world.setChunkType(x + 8, y + 1, z + 6, Material.NETHER_BRICKS);
		world.setChunkType(x + 8, y + 1, z + 9, Material.NETHER_BRICKS);
		world.setChunkType(x + 9, y + 1, z + 7, Material.NETHER_BRICKS);
		world.setChunkType(x + 9, y + 1, z + 8, Material.NETHER_BRICKS);
		world.setChunkType(x + 6, y + 2, z + 7, Material.NETHER_BRICKS);
		world.setChunkType(x + 6, y + 2, z + 8, Material.NETHER_BRICKS);
		world.setChunkType(x + 7, y + 2, z + 6, Material.NETHER_BRICKS);
		world.setChunkType(x + 7, y + 2, z + 9, Material.NETHER_BRICKS);
		world.setChunkType(x + 8, y + 2, z + 6, Material.NETHER_BRICKS);
		world.setChunkType(x + 8, y + 2, z + 9, Material.NETHER_BRICKS);
		world.setChunkType(x + 9, y + 2, z + 7, Material.NETHER_BRICKS);
		world.setChunkType(x + 9, y + 2, z + 8, Material.NETHER_BRICKS);
		world.setChunkType(x + 7, y + 3, z + 7, Material.NETHER_BRICKS);
		world.setChunkType(x + 7, y + 3, z + 8, Material.NETHER_BRICKS);
		world.setChunkType(x + 8, y + 3, z + 7, Material.NETHER_BRICKS);
		world.setChunkType(x + 8, y + 3, z + 8, Material.NETHER_BRICKS);

		// Ores
		world.setChunkType(x + 7, y + 1, z + 7, Material.IRON_ORE);
		world.setChunkType(x + 7, y + 1, z + 8, Material.REDSTONE_ORE);
		world.setChunkType(x + 8, y + 1, z + 7, Material.IRON_ORE);

		// Chest
		world.setChunkType(x + 8, y + 1, z + 8, Material.CHEST);
		{
			Chest_Later later = new Chest_Later(chunkx * 16 + x + 8, y + 1, chunkz * 16 + z + 8, rand,
					getItemsToChest(rand, world));
			world.addLater(later);
		}
//		addItemsToChest(rand, (Chest) world.setChunkType(x + 8, y + 1, z + 8).getState(), world);
		...
		if (zombie) {
			Spawner_Later later = new Spawner_Later(chunkx * 16 + x + 8, y + 2, chunkz * 16 + z + 8, EntityType.ZOMBIE);
			world.addLater(later);
		}
