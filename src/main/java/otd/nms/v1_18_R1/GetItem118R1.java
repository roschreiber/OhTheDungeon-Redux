...
public class GetItem118R1 implements GetItem {
...
//			throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		item.a("id", itemName);
		item.a("Count", 1);
//		MultiVersion.NMS_1_18.NBTTagCompound_SetString.invoke(item, "id", itemName);
//		MultiVersion.NMS_1_18.NBTTagCompound_SetInt.invoke(item, "Count", 1);
