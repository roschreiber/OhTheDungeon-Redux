...
public class GetNBTTagList118R1 implements GetNBTTagList {
...
//				try {
//					MultiVersion.NMS_1_18.NBTTagCompound_Set.invoke(data, "data", sp.getPotential(mob));
//					MultiVersion.NMS_1_18.NBTTagCompound_SetInt.invoke(data, "weight", sp.weight);
...
//			try {
//				MultiVersion.NMS_1_18.NBTTagCompound_Set.invoke(data, "data",
