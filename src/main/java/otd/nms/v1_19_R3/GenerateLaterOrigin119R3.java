...
public class GenerateLaterOrigin119R3 implements GenerateLaterOrigin {
	public void generate_chunk(Chunk chunk, Coord pos, IWorldEditor editor, Random rand, Coord cursor, int level,
		...
		org.bukkit.craftbukkit.v1_19_R3.CraftWorld ws = (org.bukkit.craftbukkit.v1_19_R3.CraftWorld) tileentity
				.getWorld();
