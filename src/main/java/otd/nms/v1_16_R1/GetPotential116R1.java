...
public class GetPotential116R1 implements GetPotential {
	public Object get(Object mob, SpawnPotential sp) {
		net.minecraft.server.v1_16_R1.NBTTagCompound potential = new net.minecraft.server.v1_16_R1.NBTTagCompound();
