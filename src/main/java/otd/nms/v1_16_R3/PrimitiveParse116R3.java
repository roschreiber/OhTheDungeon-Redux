...
public class PrimitiveParse116R3 implements PrimitiveParse {
	public Object parseDouble(Primitive p) throws NBTException {
		return net.minecraft.server.v1_16_R3.NBTTagDouble
	...
	public Object parseInteger(Primitive p) throws NBTException {
		return net.minecraft.server.v1_16_R3.NBTTagInt.a(Integer.parseInt(p.jsonValue));
	}

	public Object parseDoubleUntyped(Primitive p) throws NBTException {
		return net.minecraft.server.v1_16_R3.NBTTagDouble.a(Double.parseDouble(p.jsonValue));
	}

	public Object parseBoolean(Primitive p) throws NBTException {
		return net.minecraft.server.v1_16_R3.NBTTagByte.a((byte) (Boolean.parseBoolean(p.jsonValue) ? 1 : 0));
	}
