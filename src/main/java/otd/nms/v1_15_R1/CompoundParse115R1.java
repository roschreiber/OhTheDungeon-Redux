...
public class CompoundParse115R1 implements CompoundParse {
	public Object parse(Compound c) throws NBTException {
		...
		for (JsonToNBT.Any jsontonbt$any : c.tagList) {
			nbttagcompound.set(jsontonbt$any.json, (net.minecraft.server.v1_15_R1.NBTBase) jsontonbt$any.parse());
		}
