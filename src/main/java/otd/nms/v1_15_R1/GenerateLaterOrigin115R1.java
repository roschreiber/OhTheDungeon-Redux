...
public class GenerateLaterOrigin115R1 implements GenerateLaterOrigin {
	public void generate_chunk(Chunk chunk, Coord pos, IWorldEditor editor, Random rand, Coord cursor, int level,
		...
		if (!(blockState instanceof CreatureSpawner))
			return;
		org.bukkit.craftbukkit.v1_15_R1.CraftWorld ws = (org.bukkit.craftbukkit.v1_15_R1.CraftWorld) tileentity
				.getWorld();
		net.minecraft.server.v1_15_R1.TileEntity te = ws.getHandle()
				.getTileEntity(new net.minecraft.server.v1_15_R1.BlockPosition(pos.getX(), pos.getY(), pos.getZ()));
		if (te == null)
			return;
