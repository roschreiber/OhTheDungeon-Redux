...
public class GetSpawnPotentials115R1 implements GetSpawnPotentials {
	public Object get(Random rand, int level, Spawnable s) {
		...
		for (SpawnPotential potential : s.potentials) {
			net.minecraft.server.v1_15_R1.NBTTagCompound nbt = (net.minecraft.server.v1_15_R1.NBTTagCompound) potential
