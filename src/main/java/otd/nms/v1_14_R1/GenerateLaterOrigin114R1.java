...
public class GenerateLaterOrigin114R1 implements GenerateLaterOrigin {
	public void generate(Coord pos, IWorldEditor editor, Random rand, Coord cursor, int level, Spawnable s) {
		...
		if (!(blockState instanceof CreatureSpawner))
			return;
		org.bukkit.craftbukkit.v1_14_R1.CraftWorld ws = (org.bukkit.craftbukkit.v1_14_R1.CraftWorld) tileentity
				.getWorld();
		net.minecraft.server.v1_14_R1.TileEntity te = ws.getHandle()
				.getTileEntity(new net.minecraft.server.v1_14_R1.BlockPosition(pos.getX(), pos.getY(), pos.getZ()));
		if (te == null)
			return;
