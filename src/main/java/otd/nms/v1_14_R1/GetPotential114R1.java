...
public class GetPotential114R1 implements GetPotential {
	public Object get(Object mob, SpawnPotential sp) {
		net.minecraft.server.v1_14_R1.NBTTagCompound potential = new net.minecraft.server.v1_14_R1.NBTTagCompound();
