...
public class GenerateLaterOrigin120R2 implements GenerateLaterOrigin {
	public void generate_chunk(Chunk chunk, Coord pos, IWorldEditor editor, Random rand, Coord cursor, int level,
		...
		org.bukkit.craftbukkit.v1_20_R2.CraftWorld ws = (org.bukkit.craftbukkit.v1_20_R2.CraftWorld) tileentity
				.getWorld();
