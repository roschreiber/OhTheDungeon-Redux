...
public class Spawner_Later extends Later {
	...
	private static boolean generate(final Chunk chunk, final Random random, Coord pos, String mob) {
		...
		SpawnerDecryAPI.setSpawnerDecry(block, Main.instance, DungeonType.AntMan, true);

		return true;
	}

	public static boolean generate_later(final AsyncWorldEditor world, final Random random, ICoords coords,
			String mob) {
