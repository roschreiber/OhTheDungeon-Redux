 ...
 */
package otd.lib.io.github.jdiemke.triangulation;
...
public class DelaunayTriangulator {
	 ...
	 * 
	 * @throws NotEnoughPointsException Thrown when the point set contains less than
	 *                                  three points
	 */
	 ...
	 * implementation of the Delaunay algorithm this can speed up the computation.
	 */
	public void shuffle() {
