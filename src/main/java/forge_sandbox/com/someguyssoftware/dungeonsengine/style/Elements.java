...
public class Elements {
	...
	public static IArchitecturalElement CROWN = new ArchitecturalElement("crown", 100, 0, FACADE)
			.setFace(Face.INTERIOR);
	public static IArchitecturalElement CORNICE = new ArchitecturalElement("cornice", 100, 0, FACADE)
			.setFace(Face.EXTERIOR);
	public static IArchitecturalElement PLINTH = new ArchitecturalElement("plinth", 0, 0, FACADE)
			.setFace(Face.EXTERIOR);

	public static IArchitecturalElement PILASTER = new ArchitecturalElement("pilaster", 100, 100)
			.setFace(Face.INTERIOR);
	public static IArchitecturalElement PILASTER_BASE = new ArchitecturalElement("pilaster_base", 100, 0)
			.setFace(Face.INTERIOR);
	public static IArchitecturalElement PILASTER_CAPITAL = new ArchitecturalElement("pilaster_capital", 100, 0)
			.setFace(Face.INTERIOR);
	public static IArchitecturalElement PILLAR = new ArchitecturalElement("pillar", 100, 100).setFace(Face.INTERIOR);
	public static IArchitecturalElement PILLAR_BASE = new ArchitecturalElement("pillar_base", 100, 0)
			.setFace(Face.INTERIOR);
	public static IArchitecturalElement PILLAR_CAPITAL = new ArchitecturalElement("pillar_capital", 100, 0)
			.setFace(Face.INTERIOR);

	public static IArchitecturalElement CRENELLATION = new ArchitecturalElement("crenellation", 100, 50)
			.setFace(Face.EXTERIOR);
	...
	public static IArchitecturalElement COFFERED_MIDBEAM = new ArchitecturalElement("coffered_midbeam", 100, 100)
			.setFace(Face.INTERIOR);
	public static IArchitecturalElement COFFERED_CROSSBEAM = new ArchitecturalElement("coffered_crossbeam", 100, 100)
			.setFace(Face.EXTERIOR);
	...
	public enum ElementsEnum implements IEnum {
		NONE(-1, Elements.NONE.getName(), Elements.NONE), AIR(0, Elements.AIR.getName(), Elements.AIR),
		...
		FLOOR_ALT(1, Elements.FLOOR_ALT.getName(), Elements.FLOOR_ALT), WALL(2, Elements.WALL.getName(), Elements.WALL),
		...
		CEILING(3, Elements.CEILING.getName(), Elements.CEILING), BASE(4, Elements.BASE.getName(), Elements.BASE),
		COLUMN(5, Elements.COLUMN.getName(), Elements.COLUMN), CAPITAL(6, Elements.CAPITAL.getName(), Elements.CAPITAL),
		TRIM(7, Elements.TRIM.getName(), Elements.TRIM), CROWN(8, Elements.CROWN.getName(), Elements.CROWN),
		...
		GUTTER(26, Elements.GUTTER.getName(), Elements.GUTTER), GRATE(27, Elements.GRATE.getName(), Elements.GRATE),
		WINDOW(27, Elements.WINDOW.getName(), Elements.WINDOW), SIGN(28, Elements.SIGN.getName(), Elements.SIGN),
