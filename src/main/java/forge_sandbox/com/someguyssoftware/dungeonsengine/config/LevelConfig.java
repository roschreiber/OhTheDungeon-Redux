...
public class LevelConfig implements ILevelConfig {
	...
	public ILevelConfig apply(ILevelConfig config) {
		...
		if (getChestConfig() == null)
			setChestConfig(new ChestConfig(config.getChestConfig()));
		else
			getChestConfig().apply(config.getChestConfig());

		if (getChestCategories() == null || !getChestCategories().isEmpty()) {
		...
		if (isDecorations() == null)
			setDecorations(config.isDecorations());
		if (getDegrees() == null)
			setDegrees(config.getDegrees());
		if (getDepth() == null)
		...
		if (getNumRooms() == null)
			setNumRooms(config.getNumRooms());
		if (getSpawnBoundaryFactor() == null)
			setSpawnBoundaryFactor(config.getSpawnBoundaryFactor());
		if (getSpawnerFrequency() == null)
			setSpawnerFrequency(config.getSpawnerFrequency());
		if (isSupport() == null)
			setSupport(config.isSupport());
	...
	public String toString() {
		return "LevelConfig [boundaryFactor=" + boundaryFactor + ", spawnBoundaryFactor=" + spawnBoundaryFactor
				+ ", numRooms=" + numRooms + ", width=" + width + ", depth=" + depth + ", height=" + height
				+ ", degrees=" + degrees + ", decayMultiplier=" + decayMultiplier + ", spawnerFrequency="
				+ spawnerFrequency + ", chestConfig=" + chestConfig + ", chestFrequency=" + chestFrequency
				+ ", chestCategories=" + chestCategories + ", numberOfWebs=" + numberOfWebs + ", webFrequency="
				+ webFrequency + ", numberOfVines=" + numberOfVines + ", vineFrequency=" + vineFrequency + ", theme="
				+ theme + ", support=" + support + ", decorations=" + decorations + "]";
	}
