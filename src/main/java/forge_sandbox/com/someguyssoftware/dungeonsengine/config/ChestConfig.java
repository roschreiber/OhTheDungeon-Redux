...
public class ChestConfig implements IChestConfig {
	...
	public IChestConfig apply(IChestConfig config) {
		if (getLootTableMethod() == null)
			setLootTableMethod(config.getLootTableMethod());
		if (getLootTableName() == null)
			setLootTableName(config.getLootTableName());
		if (getProbability() == null)
			setProbability(new Quantity(config.getProbability()));
		if (getRarity() == null)
			setRarity(new ArrayList<>(config.getRarity()));
		return this;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.someguyssoftware.dungeonsengine.config.IChestConfig#setRarity(com.
	 * someguyssoftware.gottschcore.enums.Rarity)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IChestConfig#setProbability(com.
	 * someguyssoftware.gottschcore.Quantity)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IChestConfig#getLootTableType()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IChestConfig#setLootTableType(java
	 * .lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IChestConfig#getLootTableName()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IChestConfig#setLootTableName(java
	 * .lang.String)
	 */
	@Override
	...
	public String toString() {
		return "ChestConfig [rarity=" + rarity + ", probability=" + probability + ", lootTableMethod=" + lootTableMethod
