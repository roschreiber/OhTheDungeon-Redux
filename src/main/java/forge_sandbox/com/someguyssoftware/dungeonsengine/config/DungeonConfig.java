...
public class DungeonConfig implements IDungeonConfig {
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IDungeonConfig#setNumLevels(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IDungeonConfig#setTopLimit(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IDungeonConfig#getBottomLimit()
	 */
	@Override
...
//		return bottomLimit;
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IDungeonConfig#setBottomLimit(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IDungeonConfig#getLevelConfigs()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.someguyssoftware.dungeonsengine.config.IDungeonConfig#setLevelConfigs(com
	 * .someguyssoftware.dungeonsengine.config.ILevelConfig)
	 */
	@Override
	...
	public String toString() {
		return "DungeonConfig [name=" + name + ", version=" + version + ", size=" + size + ", numLevels=" + numLevels
				+ ", bottomLimit=" + bottomLimit + ", topLimit=" + topLimit + ", surfaceBuffer=" + surfaceBuffer
				+ ", biomeWhiteList=" + biomeWhiteList + ", biomeBlackList=" + biomeBlackList + ", boundaryFactor="
				+ boundaryFactor + ", levelConfigs=" + Arrays.toString(levelConfigs) + ", surfaceConfig="
				+ surfaceConfig + "]";
	}
