...
public class Intersect {
	...
	public static Intersect getIntersect(BBox bb1, BBox bb2) {
		double x = Math.max(0.0, Math.abs(Math.min(bb1.getMaxCoords().getX(), bb2.getMaxCoords().getX())
				- Math.max(bb1.getMinCoords().getX(), bb2.getMinCoords().getX())));
		double y = Math.max(0.0, Math.abs(Math.min(bb1.getMaxCoords().getY(), bb2.getMaxCoords().getY())
				- Math.max(bb1.getMinCoords().getY(), bb2.getMinCoords().getY())));
		double z = Math.max(0.0, Math.abs(Math.min(bb1.getMaxCoords().getZ(), bb2.getMaxCoords().getZ())
				- Math.max(bb1.getMinCoords().getZ(), bb2.getMinCoords().getZ())));
