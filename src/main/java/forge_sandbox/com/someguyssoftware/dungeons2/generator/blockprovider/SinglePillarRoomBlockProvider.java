...
/**
 * Creates a room where the pillars are generated in a single ring around the
 * inner edge of the room.
 * 
...
public class SinglePillarRoomBlockProvider implements IDungeonsBlockProvider {
	...
	public boolean isPillarElement(ICoords coords, Room room, Layout layout) {
		...
		// check if at an inner ring either 1 space away from wall or 2 spaces from wall
		// if there are pilasters
