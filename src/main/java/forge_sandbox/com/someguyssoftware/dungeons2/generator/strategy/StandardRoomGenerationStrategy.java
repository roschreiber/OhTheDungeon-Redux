		...
		for (int y = 0; y < room.getHeight(); y++) {
			...
			for (int z = 0; z < room.getDepth(); z++) {
				for (int x = 0; x < room.getWidth(); x++) {
					...
					/*
					 * TODO need to add a type of DesignElement that helps age the room. Something
					 * to define if it is something that can be placed on the floor (ymin+1) or
					 * something that can hang from ceiling (ymax-1). This would be used for webs
					 * etc.
					 */
