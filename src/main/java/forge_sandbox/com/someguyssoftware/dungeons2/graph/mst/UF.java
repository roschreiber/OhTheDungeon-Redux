 ...
 * are identified with integers between 0 and <em>N</em> &ndash; 1. Initially,
 * there are <em>n</em> components, with each site in its own component. The
...
public class UF {
	 ...
	 * <tt>0</tt> through <tt>n-1</tt>. Each site is initially in its own component.
	 *
