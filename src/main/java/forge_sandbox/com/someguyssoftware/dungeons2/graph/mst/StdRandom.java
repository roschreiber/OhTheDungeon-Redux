...
public final class StdRandom {
	 ...
	 *         probability <tt>p</tt>; or <tt>Integer.MAX_VALUE</tt> if <tt>p</tt>
	 *         is (nearly) equal to <tt>1.0</tt>.
	 * @throws IllegalArgumentException unless <tt>p >= 0.0</tt> and
	 *                                  <tt>p <= 1.0</tt>
	 */
	 ...
	 *                                  equal to <tt>1.0</tt>
	 * @throws IllegalArgumentException unless <tt>probabilities[i] >= 0.0</tt> for
	 *                                  each index <tt>i</tt>
	 */
