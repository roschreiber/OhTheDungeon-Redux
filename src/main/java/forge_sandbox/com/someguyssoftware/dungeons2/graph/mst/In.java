...
public final class In {
	...
	/**
	 * Reads the next token from this input stream, parses it as a <tt>int</tt>, and
	 * returns the <tt>int</tt>.
	 *
	 ...
	 * (interpreting either <tt>"true"</tt> or <tt>"1"</tt> as <tt>true</tt>, and
	 * either <tt>"false"</tt> or <tt>"0"</tt> as <tt>false</tt>).
	 *
