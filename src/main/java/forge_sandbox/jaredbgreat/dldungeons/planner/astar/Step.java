...
/**
 * This meant to represent a Tile (block column / xz coordinate) that acts as a
 * both a node and an implied edge (from the previous node) in an implied
 * nav-graph consisting of the rooms floor surface.
 * 
 * The purpose of this is for storing steps on the route from door to door, both
 * in an abstract PriorityQueue and in a tree representing valid routes.
 * 
