 ...
 * <li>R: Rotational symmetry, based on a 180 degree rotation the center of the
 * room</li>
 * <li>SW: Swirled symmetry, rotating 90 degrees around the center of the
 * room</li>
 * </ol>
 * 
...
public enum Symmetry {
	...
	NONE(0, 0, false, false, false), X(1, 1, true, false, false), Z(2, 1, false, true, false),
	XZ(3, 2, true, true, false), TR1(4, 1, false, false, true), TR2(5, 1, false, false, true),
	R(6, 1, false, false, true), SW(7, 2, true, true, false);
	...
	public static final Shapes[] allshapes = { Shapes.X, Shapes.L, Shapes.O, Shapes.T, Shapes.F, Shapes.E, Shapes.I,
			Shapes.C, Shapes.U, Shapes.S };
	...
	public static final Shapes[] allPart = { Shapes.L, Shapes.O, Shapes.T, Shapes.F, Shapes.E, Shapes.I, Shapes.C,
			Shapes.U, Shapes.S };
	...
	public static final Shapes[] allSolids = { Shapes.X, Shapes.L, Shapes.T, Shapes.F, Shapes.E, Shapes.I, Shapes.C,
			Shapes.U, Shapes.S };
	...
	/**
	 * Returns a Symmetry constant based on the dungeons degree of symmetry; used to
	 * get the symmetry type for individual rooms.
	 * 
	 * @param dungeon
