...
/**
 * A base class for all room features. This allows a chance for a type of
 * feature occurring to be store in a collection and sorted to randomize the
 * order of evaluation.
 * 
...
public abstract class FeatureAdder {
	 ...
	 * pre-defined degree of chance. The actual feature is built by calling a method
	 * back on the room. It will return true if the room was instructed to add the
	 * feature, and false otherwise; whether or not the feature was actually added
