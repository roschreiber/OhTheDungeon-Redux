...
/**
 * This class represents alternative caves created by cellular automata with a
 * "2 1/2 D" architecture.
 * 
...
public class Cave extends Room {
	...
	public Cave(int beginX, int endX, int beginZ, int endZ, int floorY, int ceilY, Dungeon dungeon, Room parent,
			Room previous) {
	...
	/**
	 * Plans the room. Chests and spawner are added in the same way as for basic
	 * rooms, but walls and variation in floor / ceiling height are determined by
	 * cellular automata to produce a more cave-like layout.
	 */
	@Override
	...
	/**
	 * Use cellular automata to determine areas of height variation (floor and
	 * ceiling) between the walls.
	 * 
	 * @param layer
	 * @param down
	 * @param thresshold
	...
	/**
	 * This process the cells for a tile, convert it to one or zero based on the sum
	 * of it and its neighbors. Note that most implementation do not consider the
	 * initial value of the cell itself, but I get good results doing so and it
	 * simplifies the code, so I do here.
	 * 
	 * @param layer
	 * @param x
	 * @param z
	...
	/**
	 * Initialize the classes internal (read, private) scratchpad for a new round of
