...
/**
 * The building block for more complex shape-primitives represented by the Shape
 * class, and thus the foundational class for all dungeon architecture.
 * 
 * Each rectangle is, if used correctly, a sub-section of a unit square centered
 * on 0,0 in the xz plane. This allows them, and thus shape built from them, to
 * be stretched to a desired size and shape (rounded) by multiplication by the
 * desired dimensions and placed by adding the coordinates of the center block
 * (which could very well be a fractional block.
 * 
 * All rectangles used are static final members of this class. The class is also
 * immutable.
 * 
...
public final class Rectangle {
	...
	public void drawLiquid(Dungeon dungeon, Room room, float sx, float sz, float sdimx, float sdimz, boolean invertX,
		...
		for (byte k = zbegin; k < zend; k++)
			for (byte j = xbegin; j < xend; j++) {
				if ((j < 0) || (j >= dungeon.size.width) || (k < 0) || (k >= dungeon.size.width))
					continue;
				if (dungeon.map.room[j][k] != room.id)
					continue;
				...
				byte nFloorY = dungeon.map.nFloorY[j][k] < dungeon.map.floorY[j][k] ? dungeon.map.nFloorY[j][k]
						: dungeon.map.floorY[j][k];
				dungeon.map.nFloorY[j][k] = nFloorY;
			}
	}

	/**
	 * Add the rectangle to as a walkway (normal floor) through a previously added
	 * pool.
	 * 
	 * @param dungeon
	 * @param room
	...
	/**
	 * Add the rectangle as a area of empty space, that is, an area from which
	 * previously place walls have been removed.
	 * 
	 * @param dungeon
	 * @param room
	 * @param sx      x coordinate
	 ...
	 * height, and is thus also used to add depression be setting the floor to a
	 * lower height rather than higher.
	 * 
	 * @param dungeon
	 * @param room
	...
	// 'U' (Works)
	public static final Rectangle uleft000 = new Rectangle(0.3333333333f, 0.6666666667f, -0.3333333333f, 0.1666666667f);
	public static final Rectangle uright000 = new Rectangle(0.3333333333f, 0.6666666667f, 0.3333333333f, 0.1666666667f);
	public static final Rectangle ubottom000 = new Rectangle(1.0f, 0.3333333333f, 0.0f, -0.3333333333f);
	public static final Rectangle uleft090 = new Rectangle(0.6666666667f, 0.3333333333f, 0.1666666667f, -0.3333333333f);
	public static final Rectangle uright090 = new Rectangle(0.6666666667f, 0.3333333333f, 0.1666666667f, 0.3333333333f);
	public static final Rectangle ubottom090 = new Rectangle(0.3333333333f, 1.0f, -0.3333333333f, 0.0f);
	public static final Rectangle uright180 = new Rectangle(0.3333333333f, 0.6666666667f, 0.3333333333f,
			-0.1666666667f);
	public static final Rectangle uleft180 = new Rectangle(0.3333333333f, 0.6666666667f, -0.3333333333f,
			-0.1666666667f);
	public static final Rectangle ubottom180 = new Rectangle(1.0f, 0.3333333333f, 0.0f, 0.3333333333f);
	public static final Rectangle uright270 = new Rectangle(0.6666666667f, 0.3333333333f, -0.1666666667f,
			-0.3333333333f);
	public static final Rectangle uleft270 = new Rectangle(0.6666666667f, 0.3333333333f, -0.1666666667f, 0.3333333333f);
	public static final Rectangle ubottom270 = new Rectangle(0.3333333333f, 1.0f, 0.333333333f, 0.0f);
