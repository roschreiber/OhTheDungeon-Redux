 ...
 * 
 * As this uses 10 ints (8 for data, 2 for processing) it should use 40 bytes if
 * data, This is more than for a short String or char[], but it should be faster
 * and difference should be negligible in a game using a gigabyte by default.
 * Then, the speed should also be negligible, especially at load time, but I
 * wanted to try this anyway.
 * 
...
public class CharSet {
	...
	/**
	 * Returns true if and only if the character in a member of the CharSet.
	 * 
	 * @param in
	 * @return
	 */
