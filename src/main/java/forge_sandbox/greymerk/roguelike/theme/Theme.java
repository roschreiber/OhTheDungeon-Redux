...
public enum Theme {
	...
	OAK, SPRUCE, CRYPT, MOSSY, MUDDY, NETHER, SANDSTONE, QUARTZ, BLING, CHECKER, RAINBOW, SNOW, JUNGLE, BRICK, DARKOAK,
	ICE, ENIKO, ENIKO2, ENIQUARTZ, ENIICE, TOWER, ETHO, CAVE, SEWER, ENDER, MINESHAFT, ETHOTOWER, PYRAMID, DARKHALL,
	TEMPLE, SANDSTONERED, HOUSE, GREY, PURPUR, HELL, TERRACOTTA, STONE, BUMBO, BIRTHDAY, COPPER;
	...
	public static ITheme getTheme(Theme type) {
		...
		case BUMBO:
			...
			break;
		case BIRTHDAY:
			theme = new ThemeBirthday();
			break;
		case COPPER:
			theme = new ThemeCopper();
			break;
		default:
			return null;
		}
	...
	public static ITheme create(JsonObject json) throws Exception {
		...
		ITheme base = json.has("base") ? Theme.getTheme(Theme.get(json.get("base").getAsString())) : null;
	...
	public static ITheme create(ITheme base, ITheme other) {
		...
		BlockSet primary = other.getPrimary() != null
				? new BlockSet(base.getPrimary() != null ? new BlockSet(base.getPrimary()) : null, other.getPrimary())
				: base.getPrimary() != null ? new BlockSet(base.getPrimary()) : null;
		BlockSet secondary = other.getSecondary() != null
				? new BlockSet(base.getPrimary() != null ? new BlockSet(base.getPrimary()) : null, other.getSecondary())
				: base.getSecondary() != null ? new BlockSet(base.getSecondary()) : null;
		return new ThemeBase(primary, secondary);
	}
