...
public class LevelSettings {
	...
	public LevelSettings(LevelSettings base, LevelSettings other, Set<SettingsType> overrides) {
		...
		this.numRooms = other.numRooms != base.numRooms && other.numRooms != NUM_ROOMS ? other.numRooms : base.numRooms;

		this.range = other.range != base.range && other.range != LEVEL_RANGE ? other.range : base.range;

		this.scatter = other.scatter != base.scatter && other.scatter != SCATTER ? other.scatter : base.scatter;

		this.levelDifficulty = (base.levelDifficulty != other.levelDifficulty && other.levelDifficulty != -1)
				|| base.levelDifficulty == -1 ? other.levelDifficulty : base.levelDifficulty;
		...
		if (base.segments != null || other.segments != null) {
			this.segments = other.segments == null ? new SegmentGenerator(base.segments)
					: new SegmentGenerator(other.segments);
		}
