...
public class RogueTower implements ITower {
	...
	public void generate(IWorldEditor editor, Random rand, ITheme theme, Coord dungeon) {
		...
		RectSolid.fill(editor, rand, new Coord(x - 2, y + 10, z - 2), new Coord(x + 2, floor.getY() - 1, z + 2), blocks,
				false, true);
		...
		RectSolid.fill(editor, rand, new Coord(x - 3, main, z - 3), new Coord(x + 3, main, z + 3),
				theme.getSecondary().getWall(), true, true);
