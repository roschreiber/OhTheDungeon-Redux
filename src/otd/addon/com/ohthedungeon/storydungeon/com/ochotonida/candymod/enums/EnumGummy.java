...
public enum EnumGummy {
    ...
    public Material getMaterial() {
        if("red".equals(this.name)) return Material.RED_TERRACOTTA;
        if("orange".equals(this.name)) return Material.ORANGE_TERRACOTTA;
        if("yellow".equals(this.name)) return Material.YELLOW_TERRACOTTA;
        if("white".equals(this.name)) return Material.WHITE_TERRACOTTA;
