...
import otd.addon.com.ohthedungeon.storydungeon.commands.CommandDebug;
...
public class PerPlayerDungeonInstance {
    ...
    public PerPlayerDungeonInstance() {
        ...
        String path = Main.instance.getDataFolder().getParentFile().toString() + File.separator + "PerPlayerDungeonInstance";
